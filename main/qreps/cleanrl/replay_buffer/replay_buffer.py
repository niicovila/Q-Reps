...
class ReplayBuffer(object):
    ...
    def get_all(self):
        ...
        log_likes_t = torch.cat(log_likes_t, axis=0); log_likes_t = log_likes_t.reshape(log_likes_t.shape[0], -1); log_likes_t = torch.tensor(log_likes_t, device=self.device).float()
